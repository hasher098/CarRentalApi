    ...
    public class CarRentDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Car>().HasData(
                 new Car { Id = 1, Class = "B", Brand = "Kia", Model = "Rio", Year = 2012, Color = "Biały", EngineCapacity = "1.4", Seats = 5,
                     Gearbox = "M",  TrunkCapacity = "400L", RoofRack = false, BodyType = "Hatchback", image = "https://www.newsauto.pl/wp-content/uploads/2018/03/kia-gene-rio1.jpg" },
                 new Car { Id = 2, Class = "B", Brand = "Toyota", Model = "Yaris", Year = 2015, Color = "Czerwony", EngineCapacity = "1.0", Seats = 5, 
                     Gearbox = "M", TrunkCapacity = "768L", RoofRack = false, BodyType = "Hatchback", image = "https://ocdn.eu/pulscms-transforms/1/JiNktkuTURBXy8wZDczN2QxNC03MTU3LTRiMWYtYjA4ZS02YjA2Y2M2ODMyMTUuanBlZ5GVAs0EsM0CpMLD" },
                 new Car { Id = 3, Class = "B", Brand = "Opel", Model = "Corsa", Year = 2016, Color = "Zielony", EngineCapacity = "1.6 T", Seats = 5,
                     Gearbox = "A", TrunkCapacity = "1100L", RoofRack = false, BodyType = "Hatchback", image = "https://www.autobaza.pl/blog/wp-content/uploads/2019/06/corsa-740x431@2x.jpg"},
                 new Car { Id = 4, Class = "D", Brand = "Volkswagen", Model = "Passat", Year = 2016, Color = "Szary", EngineCapacity = "2.0", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "1150L", RoofRack = false, BodyType = "Kombi", image = "https://i.wpimg.pl/1200x0/m.autokult.pl/vw-passat-rline-2019-5-e3cfb69cb.jpg" },
                 new Car { Id = 5, Class = "D", Brand = "Opel", Model = "Insignia", Year = 2016, Color = "Niebieski", EngineCapacity = "2.0", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "1470L", RoofRack = false, BodyType = "Sedan", image = "https://dixi-car.pl/foto/galeria/insignia-b-fl/nowy-opel-insignia-grand-sport-fl.jpg" },
                 new Car { Id = 6, Class = "A", Brand = "Nissan", Model = "Micra", Year = 2015, Color = "Pomarańczowy", EngineCapacity = "1.0", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "800L", RoofRack = false, BodyType = "Hatchback", image = "https://www-europe.nissan-cdn.net/content/dam/Nissan/nissan_europe/Configurator/Micra-March/k14a/grade/16TDIeulhd_B02E_MICRA_HELIOSConfigurator_002.jpg.ximg.l_12_m.smart.jpg" },
                 new Car { Id = 7, Class = "A", Brand = "Nissan", Model = "Micra", Year = 2015, Color = "Czerwony", EngineCapacity = "1.0", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "800L", RoofRack = false, BodyType = "Hatchback", image = "https://cdntdreditorials.azureedge.net/cache/7/e/6/b/6/3/7e6b63e11ab1d8dabff7dc0178b2653486e31f96.jpg" },
                 new Car { Id = 8, Class = "B", Brand = "Volkswagen", Model = "Golf", Year = 2017, Color = "Limonkowy", EngineCapacity = "2.0 TSI", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "800L", RoofRack = false, BodyType = "Hatchback", image = "https://www.autocentrum.pl/ac-file/gallery-photo/5df60c2b57502acb2539841e/volkswagen-golf.jpg" },
                 new Car { Id = 9, Class = "D", Brand = "Volkswagen", Model = "Passat", Year = 2013, Color = "Czarny", EngineCapacity = "2.0 TSI", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "1400L", RoofRack = true, BodyType = "Kombi", image = "https://image.ceneostatic.pl/data/products/66665781/i-volkswagen-passat-b8-2017-190km-kombi-czarny.jpg" },
                 new Car { Id = 10, Class = "D", Brand = "Mazda", Model = "6", Year = 2015, Color = "Czerwony", EngineCapacity = "2.0 Skyaktiv", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "1400L", RoofRack = true, BodyType = "Sedan", image = "https://wokolmotoryzacji.pl/wp-content/uploads/2020/04/2023-mazda-6-rendering-1024x576.jpg" },
                 new Car { Id = 11, Class = "D", Brand = "Ford", Model = "Mondeo", Year = 2016, Color = "Czarny", EngineCapacity = "2.0 TDCi", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "1450L", RoofRack = false, BodyType = "Sedan", image = "https://img.tipcars.com/fotky_velke/18082919_1/1572854594/E/ford-mondeo-2-0-tdci-titanium.jpg" },
                 new Car { Id = 12, Class = "F", Brand = "Audi", Model = "A8", Year = 2016, Color = "Czarny", EngineCapacity = "4.2 TDI", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "1700L", RoofRack = false, BodyType = "Sedan", image = "https://i.wpimg.pl/730x0/m.autokult.pl/2021-audi-a8-l-security--ec2f982.jpg" },
                 new Car { Id = 13, Class = "F", Brand = "Audi", Model = "A6", Year = 2017, Color = "Niebieski", EngineCapacity = "3.0 TDI", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "1570L", RoofRack = true, BodyType = "Sedan", image = "https://i.wpimg.pl/985x0/m.autokult.pl/audi-a6-ae1f38db7ee5e6b7d4322d1d.jpg" },
                 new Car { Id = 14, Class = "S", Brand = "Audi", Model = "RS6", Year = 2019, Color = "Zielony", EngineCapacity = "5.0 V10 TFSI", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "1500L", RoofRack = false, BodyType = "Kombi", image = "https://wokolmotoryzacji.pl/wp-content/uploads/2020/05/Wheelsandmore-Audi-RS6-Avant-1-1024x724.jpg" },
                 new Car { Id = 15, Class = "A", Brand = "Fiat", Model = "Panda", Year = 2017, Color = "Biały", EngineCapacity = "1.0", Seats = 5, 
                     Gearbox = "M", TrunkCapacity = "1000L", RoofRack = false, BodyType = "Hatchback", image = "https://img.chceauto.pl/arts/3904/fiat-panda-waze-31419_v1.jpg" },
                 new Car { Id = 16, Class = "C", Brand = "BMW", Model = "Seria 1", Year = 2013, Color = "Granatowy", EngineCapacity = "2.0 D", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "1280L", RoofRack = false, BodyType = "Hatchback", image = "https://www.wyborkierowcow.pl/wp-content/uploads/2017/08/BMW-serii-1-sylwetka-1.jpg" },
                 new Car { Id = 17, Class = "C", Brand = "Audi", Model = "A3", Year = 2014, Color = "Czarny", EngineCapacity = "2.0 TDI", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "1250L", RoofRack = false, BodyType = "Sedan", image = "https://ireland.apollo.olxcdn.com/v1/files/eyJmbiI6InI2a2RyamFocTJodi1PVE9NT1RPUEwiLCJ3IjpbeyJmbiI6IndnNGducXA2eTFmLU9UT01PVE9QTCIsInMiOiIxNiIsInAiOiIxMCwtMTAiLCJhIjoiMCJ9XX0.TMLNc1Ljd6NGiAk5PU5wHeMbqFMTLJfj8xn0md7vgwk/image;s=1080x720" },
                 new Car { Id = 18, Class = "S", Brand = "Lamborghini", Model = "Aventador", Year = 2016, Color = "Żółty", EngineCapacity = "6.5 V12", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "1450L", RoofRack = false, BodyType = "Coupe", image = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/2015_Lamborghini_Aventador_LP700-4_Pirelli_Edition_6.5_Front.jpg/1200px-2015_Lamborghini_Aventador_LP700-4_Pirelli_Edition_6.5_Front.jpg" },
                 new Car { Id = 19, Class = "S", Brand = "Audi", Model = "R8", Year = 2018, Color = "Niebieski", EngineCapacity = "5.2", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "---", RoofRack = false, BodyType = "Coupe", image = "https://www.auto-motor-i-sport.pl/media/lib/2555/2019-audi-r8.jpg" },
                 new Car { Id = 20, Class = "H", Brand = "Audi", Model = "TT", Year = 2015, Color = "Biały", EngineCapacity = "2.0 TFSI", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "600L", RoofRack = false, BodyType = "Cabriolet", image = "https://image.ceneostatic.pl/data/products/73512595/i-audi-tt-s-line-tfsi-2010-2-0-200-km-194-000km.jpg" },
                 new Car { Id = 21, Class = "H", Brand = "BMW", Model = "Z4", Year = 2016, Color = "Biały", EngineCapacity = "2.5", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "280L", RoofRack = false, BodyType = "Cabriolet", image = "https://media.istockphoto.com/photos/white-bmw-z4-sports-car-picture-id458934741" },
                 new Car { Id = 22, Class = "M", Brand = "Volkswagen", Model = "Sharan", Year = 2016, Color = "Czarny", EngineCapacity = "2.0 TDI", Seats = 7,
                     Gearbox = "AT", TrunkCapacity = "2000L", RoofRack = false, BodyType = "Van", image = "https://a.allegroimg.com/s512/11f6a1/16b75bc14ce790cd1da60cd90de2/VW-SHARAN-2-0-TDI-140KM_BOGATY_WLASCICIEL-BOGATY" },
                 new Car { Id = 23, Class = "M", Brand = "Seat", Model = "Alhambra", Year = 2018, Color = "Czerwony", EngineCapacity = "2.0 TDI", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "2000L", RoofRack = false, BodyType = "Van", image = "https://www.autocentrum.pl/ac-file/gallery-photo/5dd3e3e5583a0f08331e2683.jpg" },
                 new Car { Id = 24, Class = "M", Brand = "Ford", Model = "Galaxy", Year = 2017, Color = "Granatowy", EngineCapacity = "2.0 Ecoblue", Seats = 5,
                     Gearbox = "AT", TrunkCapacity = "2000L", RoofRack = false, BodyType = "Minivan", image = "https://mojepokrowce.pl/userdata/public/gfx/847b505b0cacd7c8a3540c729178eaa9.jpg" },
                 new Car { Id = 25, Class = "J", Brand = "Audi", Model = "Q7", Year = 2017, Color = "Czerwony", EngineCapacity = "3.0 TDI", Seats = 5,
                     Gearbox = "M", TrunkCapacity = "1930L", RoofRack = true, BodyType = "SUV", image = "https://i.wpimg.pl/1641x0/m.autokult.pl/audi-q7-2020-12-db837ab88fc7ecce,0,0,0,0.jpg" }
                 );
            ...
            builder.Entity<CarCopy>().HasData(
                new CarCopy { Id = 1, RegistrationNumber = "ERA 2137P", CarId = 1, IsRented = false },
                ...
                new CarCopy { Id = 4, RegistrationNumber = "SKL S8421", CarId = 4, IsRented = false },
                new CarCopy { Id = 5, RegistrationNumber = "SLU 67123", CarId = 5, IsRented = false },
                ...
                new CarCopy { Id = 8, RegistrationNumber = "SK 9632A", CarId = 8, IsRented = false },
                ...
                new CarCopy { Id = 11, RegistrationNumber = "EWI 22135", CarId = 11, IsRented = false },
                new CarCopy { Id = 12, RegistrationNumber = "SC AP442", CarId = 12, IsRented = false },
                new CarCopy { Id = 13, RegistrationNumber = "SCZ 52123", CarId = 13, IsRented = true },
                new CarCopy { Id = 14, RegistrationNumber = "GDA 32145", CarId = 14, IsRented = false },
                new CarCopy { Id = 15, RegistrationNumber = "SW 12346", CarId = 15, IsRented = false },
                ...
                new CarCopy { Id = 20, RegistrationNumber = "WU 23456", CarId = 20, IsRented = false },
                new CarCopy { Id = 21, RegistrationNumber = "WZ PQW21", CarId = 21, IsRented = false },
            ...
            builder.Entity<Rent>().HasData(
               new Rent { Id = 1, UserID = "6bb1647e-c2f3-4def-a875-32644e0b2b9f", CarCopyId = 1, 
                   RentDate = new DateTime(2020,01,01), ReturnDate = new DateTime(2020,01,05) },
               new Rent { Id = 2, UserID = "10966c59-49f1-470a-a90c-94755d3870b3", CarCopyId = 2, 
                   RentDate = new DateTime(2020,05,01), ReturnDate = new DateTime(2020,05,10) },
               new Rent { Id = 3, UserID = "c89548b7-838f-4b90-94ac-763198501ce9", CarCopyId = 3, 
                   RentDate = new DateTime(2020,07,20), ReturnDate = new DateTime(2020,07,27) },
               new Rent { Id = 4, UserID = "b889e9e9-0b5d-453f-9363-e93637b854aa", CarCopyId = 4, 
                   RentDate = new DateTime(2020,03,15), ReturnDate = new DateTime(2020,03,17) },
               new Rent { Id = 5, UserID = "304f6dbe-c471-45ad-a540-f4992be6f746", CarCopyId = 5, 
                   RentDate = new DateTime(2020,10,10), ReturnDate = new DateTime(2020,10,12) }
               );
        }
