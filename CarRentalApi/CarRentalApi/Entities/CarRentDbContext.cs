    ...
    public class CarRentDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Rent>().HasData(
               ...
               new Rent { Id = 3, UserID = "6bb1647e-c2f3-4def-a875-32644e0b2b9f", CarCopyId = 3, RentDate = data1, ReturnDate = data2 },
               new Rent { Id = 4, UserID = "6bb1647e-c2f3-4def-a875-32644e0b2b9f", CarCopyId = 4, RentDate = data1, ReturnDate = data2 },
               new Rent { Id = 5, UserID = "6bb1647e-c2f3-4def-a875-32644e0b2b9f", CarCopyId = 5, RentDate = data1, ReturnDate = data2 }*/
               );
        }
